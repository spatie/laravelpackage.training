    ...
    <li class="pt-8 text-xl">
        ...
        <div class="flex-grow">
            ...
            <ul class="mt-6 markup-ul-alt text-lg | md:markup-cols-2">
                    ...
                    <li class="pb-3">A whopping 90 minute live coding video where we bring together the knowledge of the entire course to build a real life package from scratch. Watch Freek code and explain his thought process.</li>
            </ul>
        </div>
    </li>
    ...
    <li class="pt-8 text-xl">
        ...
        <div class="flex-grow">
            ...
            <ul class="mt-6 markup-ul-alt markup-links text-lg | md:markup-cols-2">
                ...
                <li class="pb-3"><a href="{{spatieUrl('https://docs.spatie.be/laravel-medialibrary')}}">laravel-medialibrary</a>: learn how we structured this big package to keep it maintainable</li>
                <li class="pb-3"><a href="{{spatieUrl('https://docs.spatie.be/laravel-multitenancy')}}">laravel-multitenancy</a>: this source dive shows how a complicated package can remain lightweight. Lots of things to learn about the Laravel internals too.</li>
