    ...
    <div class="grid md:cols-2 items-stretch" x-data="{ open: false }">
        <div role="button"
         class="group grid place-center bg-dark-200 h-full w-full md:min-h-0" style="min-height: 56vw" @click="open = true">
            <img alt="Code snippet screenshot of the Mailcoach newsletter software" class="absolute w-full h-full object-cover object-left-top opacity-50" src="/images/screenshots/how-we-do-it.png">
            <button class="bg-dark-800 text-white rounded-sm px-3 py-1 | group-hover:bg-dark-500">
        ...
        <div class="px-8 py-24 | md:px-12 | xl:px-16">
            ...
            <p class="mt-12 text-lg">
                Developer! These videos might be for you, even if you're not in the market for an email marketing tool.
