...
@section('description', 'Terms of use for Mailcoach — a self-hosted solution to send out your email newsletters at low cost')
...
These Mailcoach terms of use (the “Terms of Use”) apply to all services provided through <https://laravelpackage.training/> by Spatie BV, with registered offices at Kruikstraat 22/12, 2060 Antwerp, Belgium and registered at the CBE under number BE 0809.387.596 hereafter referred to as “Mailcoach” “we”, “us” or “our”.
...
If you have any questions or concerns, you may contact us by email at [mailcoach@spatie.be](mailto:mailcoach@spatie.be).

## 1. Definitions

The following definitions apply to these Terms of Use:

1. “Fee”: the amount to be paid to Mailcoach to obtain a Software License for one year . This fee shall always be available at <https://laravelpackage.training>;
2. “Software”: the Mailcoach software as a software product listed and described on <https://laravelpackage.training>, including all present and future bug fixes, corrections, updates, upgrades, modifications, new features or functionalities and documentation through videos;
3. “Software License”: the non-exclusive, non-transferable, limited right to access, use and download the Sofware in accordance with these Terms of Use;
4. “Terms of Use”: these terms of use;
5. “You”: any user of the Software.

## 2. Content of the Software

2.1. By accepting these Terms of Use, Mailcoach grants You access to the Software after the payment of the Fee. You can always read the content of the Software and all of its features at: <https://laravelpackage.training>.
...
3.2. The installation package shall be available after the payment of the Fee. You have to fill in a purchase form at <https://laravelpackage.training> with your personal- and payment information. Mailcoach reserves the right to cancel the purchase if the purchase form is incomplete or incorrect.
...
3.6. The Software License is always bound to one domain or one subdomain.

3.7. If You want to run the Software on another domain or subdomain, You shall need an additional Software License.

3.8. You shall be able to determine which Software License belongs to which domain or subdomain. If You have purchased a Software License, You can always invite other members to the Software after the installation thereof.

3.9.	Mailcoach provides the following purchasing options:

- The Mailcoach package: this package shall contain the Mailcoach install package and extra video footage about the use of the Software.
- The Mailcoach videos: this package shall only include the video footage.

More info about the different purchase options is available at <https://laravelpackage.training>.

3.10. For purchasing the Software, a valid e-mail address is needed.
...
4.9.  We are authorized to send You messages via e-mail regarding the use of our Software. If You provide feedback or suggestions regarding our Software, we may use this information to improve the Software without any obligation to You.
...
5.1. Mailcoach may terminate or suspend your access to the Software at any time, including in the event of your actual or suspected unauthorizes use of the Software or of non-compliance with these Terms of Use, without any liability.
...
6.1. Mailcoach can update the Software and its functionalities as it deems required at its sole discretion. Mailcoach may update the Software without notifying You.

6.2. Mailcoach does not offer any technical support. Therefore Mailcoach also doesn’t support You with assistance in solving problems arising from the installation or the use of the Software. You buy the Software as it is. Mailcoach also doesn’t offer training, maintenance-, or direct support to your staff or partners.

## 7. General Terms of Payment

7.1. All payments concerning the purchase of the Software License shall be handled by [Paddle](https://paddle.com/) in accordance with its terms and conditions. Paddle handles all payments through <https://laravelpackage.training> by using Paddle’s SDK. Mailcoach does not store any of your payment details.
...
8.1. The Software License grants You permission to download, install-, and use the latest version of the Software. You do not obtain any property rights on the Software itself. At all times, Mailcoach remains the exclusive owner of the Software, as well as the sole holder of all copyrights and other intellectual property rights on this Software. Its code and structure are valuable trade secrets of Mailcoach, which are protected by applicable law.

8.2.Mailcoach does not store any user data, but the Software stores e-mail addresses and e-mail lists. According to the General Data Protection Regulation, Mailcoach itself cannot be considered a data processor. Mailcoach doesn’t save any subscribers, subscriber lists, e-mails, or e-mail templates of You. Any personal data that we may collect shall be processed in accordance with our privacy policy. By using our Software, You consent with this privacy policy.

8.3. Intellectual property rights protect the installation packages of the Software.

8.4. It is forbidden to use the Software to (try to) develop your own SaaS. Mailcoach reserves all its rights to take legal action if You try to convert the Software to create Your own SaaS.

8.5. All the ideas, software code and arrangements shall remain the exclusive property of Mailcoach and shall under no circumstances be communicated to third parties. Copying of the Software in any form whatsoever and using any process whatsoever, is strictly forbidden.

## 9. Disclaimer of Warranty

9.1. The Software is provided as is, “as available” and without warranties of any kind, either express or implied. Mailcoach does not warrant that the Software shall meet your requirements or that the Software shall be uninterrupted or error-free. To the fullest extent permitted by law, we disclaim all warranties, express or implied, including but not limited to implied warranties of merchantability, satisfactory quality and fitness for a particular purpose, compatibility, security, or accuracy.

9.2. Any use of the Software by You is under your responsibility and at your own risk. You are the sole responsible for the accuracy of data input into the Software. In no event shall Mailcoach be liable concerning the consequences of the use of the Software by You.

9.3. You acknowledge and agree that Mailcoach has no obligation to maintain, support, upgrade or update the Software.

9.4. To the extent permitted by applicable law, Mailcoach shall not be liable for delays, service interruption or other issues inherent to the use of the Internet and electronic communications or other system beyond the control of Mailcoach.

9.5. To the extent permitted by applicable law, the maximum liability of Mailcoach for any damage resulting from the use of the Software or related to these Terms of Use, whether contractual or extra-contractual, is limited to the actual direct damage.

## 10. Indemnification

10.1. You agree to indemnify and hold harmless Mailcoach, our affiliates and our officers, directors, employees, stockholders, agents and representatives from any and all third party claims, liability, damages and/or costs (including, but not limited to, reasonable attorney and legal fees and expenses) arising from your improper use of our Software, your violation of these Terms of Use, or your infringement, or the infringement or use by any other user of your account in relation to our Software (for example: the infringement of any intellectual property).
...
11.2. You shall be required to obtain for yourself all licenses for third-party software not included within the Software. Mailcoach does not assume any responsibility in case of infringement of such third party license terms of use by You.
