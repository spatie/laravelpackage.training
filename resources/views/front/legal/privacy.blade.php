...
@section('description', 'Privacy & cookie policy for Mailcoach — a self-hosted solution to send out your email newsletters at low cost')

@section('article')

@markdown
# Mailcoach privacy & cookie policy

This the Mailcoach privacy and cookie policy. Mailcoach is a product of Spatie BVBA, with a registered office at Kruikstraat 22/12, 2018 Antwerp, Belgium, and registered at the CBE under number BE 0809.387.596, here hereafter referred to as Mailcoach.

Please read this privacy policy carefully, because it contains essential information about the processing of your data and the use of cookies by Mailcoach. By using the website, provided through URL [https://laravelpackage.training](https://laravelpackage.training/); by creating an account, by contacting us by email/phone, by subscribing for our newsletter, you declare that you have read this privacy policy and that you explicitly agree to its content as well as to the processing itself.

## 1. General terms

1.1. Mailcoach complies through this privacy policy with the Belgian Law of 30 July 2018 on the protection of individuals concerning the processing of personal data and, as well as with the European Regulation 2016/679 of 27 April 2016 on the protection of natural persons about the processing of personal data (after this: GDPR).

1.2. Mailcoach is the controller who determines the means and purposes of the processing described below.
...
2.2. Mailcoach can collect your data through different means:
...
Mailcoach will use the obtained personal data solely for the purposes mentioned below:

- Category 1 and 4: maintaining and improving the website and the creation of anonymous statistics (the identity of particular persons or companies will not be traceable) based on the “legitimate interest” of Mailcoach to improve the service and website.
- Category 2: managing your account on the website to purchase a Mailcoach license.
- Category 3: sending direct marketing mailings, newsletters, promotions, based on your prior explicit consent. Mailcoach will not send any emails without permission. We always offer the option to unsubscribe to our mailing list.
...
Mailcoach may use your email address to send marketing as well as other news relating to Mailcoach if you subscribed to Mailcoach’s direct mailing list with consent. You can withdraw your consent at any time, without any reasoning and free of charge by, for example, clicking on the unsubscribe button provided at the bottom of each promotional email message.

3.3. Transfer to third parties:
In case of whole or partial reorganization or transfer of Mailcoach’s activities, whereby Mailcoach reorganizes, transfers, ceases her business activity or in case of bankruptcy of Mailcoach, your data may be transferred to new entities or third parties.

Mailcoach will use reasonable endeavors to inform you in advance of the fact that Mailcoach transfers your data to a third party. However, you are aware that this is not always technically or commercially possible under all circumstances.

Mailcoach will not sell, rent, or distribute your data nor place them at the disposal of third parties, except in the situations provided for in this privacy policy or in case you have given your explicit, prior consent.

3.4. Legal requirements:
In extraordinary circumstances, Mailcoach may be obliged to disclose your data following a court order or to comply with mandatory law and / or regulation. Mailcoach will, if reasonably possible, try to inform you in advance unless revealing this information is subject to legal constraints.

## 4. Duration of the processing

4.1. Mailcoach will store your data only for a period that is necessary for the processing purpose. Your account data will be stored as long as your Mailcoach account is activated. In case you have subscribed to our newsletter, we will store your data as long as you have not unsubscribed without exceeding five years.
...
You have the right to get at any moment access to your data without further costs, as well as to be informed about the purpose of the data processing by Mailcoach.

5.2. Right to rectification, erasure, and restriction:
You have the choice to share your data with Mailcoach. You also have the right to request Facade to rectify, delete or complement your data. You acknowledge that in the event of a refusal to share data or a request to remove these data, the download of the Mailcoach software, or the renewal of the Mailcoach license may not be possible. You can also request to restrict the processing of your data.
...
You can exercise your rights by contacting us, either by email at mailcoach@spatie.be, provided that you add a copy of your ID card.
...
6.2. Mailcoach shall not be liable in any way for direct or indirect damages caused by a wrongful or improper of the Mailcoach software used by a third party.

6.3. At any time, you must comply with the safety standards, for instance, by avoiding all non-authorized access to the Mailcoach software that you installed, or the Mailcoach account that is required to buy or renew your Mailcoach license on the website. You are solely responsible for the use of the Mailcoach software.

## 7. Cookies

7.1. What is a cookie?
A “cookie” is a small text file that is sent from the server of Mailcoach and is stored on your computer or mobile phone when visiting our website. This way, we can remember your preferences when visiting our website. Mailcoach can only read the information stored through these cookies.
...
- Essential website cookies: these cookies are necessary to give you as a visitor an optimal experience on our website. These cookies Mailcoach needs for some critical features like the payment of the Mailcoach license.
...
- Mailcoach session cookie: this is a unique cookie to identify a specific website visitor for the duration of his visit (session). The cookie expires after 2 hours.
- Paddle_js cookies: cookies that are necessary for our payment integration with Paddle. These cookies allow are used during the checkout process when you buy a license. More information on Paddle can be found on their website: [paddle.com](http://paddle.com/).
...
You can block cookies by activating your browser settings, which allows you to deny the cookies. Refusing certain cookies can lead to the effect of not being able to use some functionalities of the website. In case you have any more questions or remarks regarding the processing of your data, you may contact us by email spatie@laravelpackage.training.
@endmarkdown
