...
@section('auth')
    ...
    <div class="alert alert-info text-xl">
        ...
        From now on, you can log in on <a class="markup-link" href="{{spatieUrl('https://spatie.be/login')}}">https://spatie.be/login</a> to see all of your Spatie products.
    </div>
    <div class="mt-8 text-xl">
        <a href="{{spatieUrl('https://spatie.be/login')}}" class="button text-white">
